...
app.controller('AllReview', function($scope) {
    ...
    let overplayAllreview = document.querySelector("#overplayAllreview");
    let messageSuccsess = document.querySelector(".messageSuccsess");
    let DisplayMesage = document.querySelector(".DisplayMesage")
    let closeMessage = document.querySelector(".closeMessage");
    let buttonSend = document.querySelector("#SubContent");
    if(NameUser){
    ...
    if (buttonSend) {
        buttonSend.onclick = function(){
            ...
            CheckContentReview(ContentReview.value);
            console.log("running")
            if (CheckNameUser(NameUser.value) === true &&               CheckEmailUser(EmailUser.value) === true && CheckContentReview(ContentReview.value) === true) {
                overplayAllreview.style.display = "block";
                messageSuccsess.style.display = "block";
                DisplayMesage.style.display = "block";
                NameUser.value = "";
                EmailUser.value = "";
                ContentReview.value= "";
        }
    ...
    overplayAllreview.onclick = function() {
        overplayAllreview.style.display = "none";
        messageSuccsess.style.display = "none";
        DisplayMesage.style.display = "none";
...
app.controller('crtlPromotion', function($scope){
    ...
    $scope.listPromotion = [
        new promotion('images/promotion/promotion1.png', ' BUY 1 GET 1 PIZZA FOR FREE', '#2FOR1PRICE', '18-01-2023'),
        new promotion('images/promotion/promotion3.png', ' 50% OFF FOR ALL PIZZAS (SIZE M)', '#OFF50', '18-01-2023'),
        new promotion('images/promotion/promotion2.png', '$10.00 OFF FOR BEING SHALEPIZZA MEMBER', '#FIRSTACC10', 'Anytime'),
